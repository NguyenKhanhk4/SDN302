      ...
      <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-8 shadow-sm z-30 transition-all duration-200">
        ...
        <div className="flex items-center gap-4">
          ...
          <div 
            ...
            className="flex items-center gap-3 bg-[#F8FAFC] border border-gray-200 px-4 py-1.5 rounded-full cursor-pointer hover:opacity-80 transition-opacity"
          >
      ...
      {showUserInfo && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-3xl shadow-2xl relative z-10 w-full max-w-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="h-24 bg-gradient-to-r from-[#6366F1] to-purple-600 relative">
              <button 
            ...
            <div className="px-6 pb-6 relative">
              <div className="h-20 w-20 rounded-2xl bg-white p-1 absolute -top-10 shadow-lg left-6">
                <div className="w-full h-full rounded-xl bg-gradient-to-tr from-[#6366F1] to-purple-500 flex items-center justify-center text-white text-3xl font-bold shadow-inner uppercase">
                  {name.charAt(0)}
                </div>
              </div>
              <div className="pt-12">
                ...
                <p className="text-sm font-bold text-indigo-600 uppercase tracking-wider mb-6">{roleDisplay}</p>
